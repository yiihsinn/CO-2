...
void VSingleCycleCPU___024root__trace_chg_sub_0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelf->__Vm_traceActivity[1U] 
        ...
        bufp->chgIData(oldp+0,(vlSelf->SingleCycleCPU__DOT__next_PC),32);
        bufp->chgIData(oldp+1,(vlSelf->SingleCycleCPU__DOT__ALU_B),32);
        bufp->chgIData(oldp+2,(vlSelf->SingleCycleCPU__DOT__ALUOut),32);
        bufp->chgCData(oldp+3,(vlSelf->SingleCycleCPU__DOT__PCSel),2);
        bufp->chgBit(oldp+4,(vlSelf->SingleCycleCPU__DOT__BrEq));
        bufp->chgBit(oldp+5,(vlSelf->SingleCycleCPU__DOT__BrLT));
        bufp->chgBit(oldp+6,((0U == vlSelf->SingleCycleCPU__DOT__ALUOut)));
        bufp->chgIData(oldp+7,(vlSelf->SingleCycleCPU__DOT__srcB),32);
        bufp->chgIData(oldp+8,((0xfffffffeU & vlSelf->SingleCycleCPU__DOT__ALUOut)),32);
    }
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
        bufp->chgIData(oldp+41,(vlSelf->SingleCycleCPU__DOT__current_PC),32);
        bufp->chgIData(oldp+42,(((IData)(4U) + vlSelf->SingleCycleCPU__DOT__current_PC)),32);
        bufp->chgIData(oldp+43,(vlSelf->SingleCycleCPU__DOT__instruction),32);
        bufp->chgIData(oldp+44,(vlSelf->SingleCycleCPU__DOT__imm),32);
        bufp->chgIData(oldp+45,((vlSelf->SingleCycleCPU__DOT__imm 
                                 << 1U)),32);
        bufp->chgIData(oldp+46,((vlSelf->SingleCycleCPU__DOT__current_PC 
                                 + (vlSelf->SingleCycleCPU__DOT__imm 
                                    << 1U))),32);
        bufp->chgCData(oldp+47,(vlSelf->SingleCycleCPU__DOT__ALUCtl),4);
        bufp->chgCData(oldp+48,(vlSelf->SingleCycleCPU__DOT__memtoReg),2);
        bufp->chgCData(oldp+49,(vlSelf->SingleCycleCPU__DOT__ALUOp),2);
        bufp->chgBit(oldp+50,(vlSelf->SingleCycleCPU__DOT__memRead));
        bufp->chgBit(oldp+51,(vlSelf->SingleCycleCPU__DOT__memWrite));
        bufp->chgBit(oldp+52,(vlSelf->SingleCycleCPU__DOT__ALUSrc));
        bufp->chgBit(oldp+53,(vlSelf->SingleCycleCPU__DOT__regWrite));
        bufp->chgBit(oldp+54,(((0x80U > vlSelf->SingleCycleCPU__DOT__current_PC) 
                               & ((IData)(vlSelf->__VdfgTmp_hf8448a16__0) 
                                  >> 6U))));
        bufp->chgCData(oldp+55,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Control__funct3),3);
        bufp->chgCData(oldp+56,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Control__opcode),7);
        bufp->chgCData(oldp+57,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Register__readReg1),5);
        bufp->chgCData(oldp+58,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Register__readReg2),5);
        bufp->chgCData(oldp+59,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Register__writeReg),5);
    }
    ...
    bufp->chgIData(oldp+94,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs
                            [vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Register__readReg1]),32);
    bufp->chgIData(oldp+95,(vlSelf->SingleCycleCPU__DOT__readData2),32);
    bufp->chgIData(oldp+96,(vlSelf->SingleCycleCPU__DOT__memData),32);
    bufp->chgIData(oldp+97,(vlSelf->SingleCycleCPU__DOT__writeBackData),32);
    bufp->chgIData(oldp+98,(vlSelf->SingleCycleCPU__DOT__srcA),32);
    bufp->chgBit(oldp+99,((1U & (~ (IData)(vlSelf->clk)))));
}
