...
VL_ATTR_COLD void VSingleCycleCPU___024root__trace_init_sub__TOP__0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+43,"PC_plus_4", false,-1, 31,0);
    tracep->declBus(c+44,"instruction", false,-1, 31,0);
    tracep->declBus(c+95,"readData1", false,-1, 31,0);
    tracep->declBus(c+96,"readData2", false,-1, 31,0);
    tracep->declBus(c+45,"imm", false,-1, 31,0);
    tracep->declBus(c+46,"imm_shifted", false,-1, 31,0);
    tracep->declBus(c+47,"branch_target", false,-1, 31,0);
    tracep->declBus(c+2,"ALU_B", false,-1, 31,0);
    tracep->declBus(c+3,"ALUOut", false,-1, 31,0);
    tracep->declBus(c+97,"memData", false,-1, 31,0);
    tracep->declBus(c+98,"writeBackData", false,-1, 31,0);
    tracep->declBus(c+48,"ALUCtl", false,-1, 3,0);
    tracep->declBus(c+49,"memtoReg", false,-1, 1,0);
    tracep->declBus(c+50,"ALUOp", false,-1, 1,0);
    tracep->declBus(c+4,"PCSel", false,-1, 1,0);
    ...
    tracep->declBit(c+5,"BrEq", false,-1);
    tracep->declBit(c+6,"BrLT", false,-1);
    tracep->declBit(c+7,"zero_flag", false,-1);
    tracep->declBus(c+99,"srcA", false,-1, 31,0);
    tracep->declBus(c+8,"srcB", false,-1, 31,0);
    tracep->declBus(c+9,"jalr_target", false,-1, 31,0);
    ...
    tracep->declBus(c+42,"readAddr", false,-1, 31,0);
    tracep->declBus(c+44,"inst", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("m_Mux_ALU ");
    tracep->declBus(c+102,"size", false,-1, 31,0);
    ...
    tracep->declBus(c+60,"writeReg", false,-1, 4,0);
    ...
    tracep->declBus(c+46,"o", false,-1, 31,0);
...
VL_ATTR_COLD void VSingleCycleCPU___024root__trace_full_sub_0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullIData(oldp+1,(vlSelf->SingleCycleCPU__DOT__next_PC),32);
    bufp->fullIData(oldp+2,(vlSelf->SingleCycleCPU__DOT__ALU_B),32);
    bufp->fullIData(oldp+3,(vlSelf->SingleCycleCPU__DOT__ALUOut),32);
    bufp->fullCData(oldp+4,(vlSelf->SingleCycleCPU__DOT__PCSel),2);
    bufp->fullBit(oldp+5,(vlSelf->SingleCycleCPU__DOT__BrEq));
    bufp->fullBit(oldp+6,(vlSelf->SingleCycleCPU__DOT__BrLT));
    bufp->fullBit(oldp+7,((0U == vlSelf->SingleCycleCPU__DOT__ALUOut)));
    bufp->fullIData(oldp+8,(vlSelf->SingleCycleCPU__DOT__srcB),32);
    bufp->fullIData(oldp+9,((0xfffffffeU & vlSelf->SingleCycleCPU__DOT__ALUOut)),32);
    ...
    bufp->fullIData(oldp+42,(vlSelf->SingleCycleCPU__DOT__current_PC),32);
    bufp->fullIData(oldp+43,(((IData)(4U) + vlSelf->SingleCycleCPU__DOT__current_PC)),32);
    bufp->fullIData(oldp+44,(vlSelf->SingleCycleCPU__DOT__instruction),32);
    bufp->fullIData(oldp+45,(vlSelf->SingleCycleCPU__DOT__imm),32);
    bufp->fullIData(oldp+46,((vlSelf->SingleCycleCPU__DOT__imm 
                              << 1U)),32);
    bufp->fullIData(oldp+47,((vlSelf->SingleCycleCPU__DOT__current_PC 
                              + (vlSelf->SingleCycleCPU__DOT__imm 
                                 << 1U))),32);
    bufp->fullCData(oldp+48,(vlSelf->SingleCycleCPU__DOT__ALUCtl),4);
    bufp->fullCData(oldp+49,(vlSelf->SingleCycleCPU__DOT__memtoReg),2);
    bufp->fullCData(oldp+50,(vlSelf->SingleCycleCPU__DOT__ALUOp),2);
    bufp->fullBit(oldp+51,(vlSelf->SingleCycleCPU__DOT__memRead));
    bufp->fullBit(oldp+52,(vlSelf->SingleCycleCPU__DOT__memWrite));
    bufp->fullBit(oldp+53,(vlSelf->SingleCycleCPU__DOT__ALUSrc));
    bufp->fullBit(oldp+54,(vlSelf->SingleCycleCPU__DOT__regWrite));
    bufp->fullBit(oldp+55,(((0x80U > vlSelf->SingleCycleCPU__DOT__current_PC) 
                            & ((IData)(vlSelf->__VdfgTmp_hf8448a16__0) 
                               >> 6U))));
    bufp->fullCData(oldp+56,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Control__funct3),3);
    bufp->fullCData(oldp+57,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Control__opcode),7);
    bufp->fullCData(oldp+58,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Register__readReg1),5);
    bufp->fullCData(oldp+59,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Register__readReg2),5);
    bufp->fullCData(oldp+60,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Register__writeReg),5);
    ...
    bufp->fullIData(oldp+95,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs
                             [vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Register__readReg1]),32);
    bufp->fullIData(oldp+96,(vlSelf->SingleCycleCPU__DOT__readData2),32);
    bufp->fullIData(oldp+97,(vlSelf->SingleCycleCPU__DOT__memData),32);
    bufp->fullIData(oldp+98,(vlSelf->SingleCycleCPU__DOT__writeBackData),32);
    bufp->fullIData(oldp+99,(vlSelf->SingleCycleCPU__DOT__srcA),32);
    bufp->fullBit(oldp+100,((1U & (~ (IData)(vlSelf->clk)))));
