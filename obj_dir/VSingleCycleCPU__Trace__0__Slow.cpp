...
VL_ATTR_COLD void VSingleCycleCPU___024root__trace_init_sub__TOP__0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+6,"branch_target", false,-1, 31,0);
    tracep->declBus(c+55,"ALU_B", false,-1, 31,0);
    tracep->declBus(c+56,"ALUOut", false,-1, 31,0);
    tracep->declBus(c+96,"memData", false,-1, 31,0);
    tracep->declBus(c+97,"writeBackData", false,-1, 31,0);
    ...
    tracep->declBus(c+9,"ALUOp", false,-1, 1,0);
    tracep->declBit(c+12,"funct7", false,-1);
    ...
    tracep->declBus(c+56,"s2", false,-1, 31,0);
    ...
    tracep->declBit(c+63,"rst", false,-1);
    tracep->declBit(c+50,"regWrite", false,-1);
    tracep->declBus(c+15,"readReg1", false,-1, 4,0);
    tracep->declBus(c+16,"readReg2", false,-1, 4,0);
...
VL_ATTR_COLD void VSingleCycleCPU___024root__trace_full_sub_0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+5,((vlSelf->SingleCycleCPU__DOT__imm 
                             << 1U)),32);
    bufp->fullIData(oldp+6,((vlSelf->SingleCycleCPU__DOT__current_PC 
                             + (vlSelf->SingleCycleCPU__DOT__imm 
                                << 1U))),32);
    bufp->fullCData(oldp+7,(vlSelf->SingleCycleCPU__DOT__ALUCtl),4);
    ...
    bufp->fullBit(oldp+12,(((0x80U > vlSelf->SingleCycleCPU__DOT__current_PC) 
                            & ((IData)(vlSelf->__VdfgTmp_hf8448a16__0) 
                               >> 6U))));
    bufp->fullCData(oldp+13,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Control__funct3),3);
    bufp->fullCData(oldp+14,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Control__opcode),7);
    bufp->fullCData(oldp+15,(((0x80U <= vlSelf->SingleCycleCPU__DOT__current_PC)
                               ? 0U : (0x1fU & (vlSelf->__VdfgTmp_hbd8ba7e4__0 
                                                >> 0xfU)))),5);
    bufp->fullCData(oldp+16,(((0x80U <= vlSelf->SingleCycleCPU__DOT__current_PC)
    ...
    bufp->fullBit(oldp+49,(vlSelf->SingleCycleCPU__DOT__memRead));
    bufp->fullBit(oldp+50,(vlSelf->SingleCycleCPU__DOT__regWrite));
    ...
    bufp->fullIData(oldp+55,(vlSelf->SingleCycleCPU__DOT__ALU_B),32);
    bufp->fullIData(oldp+56,(vlSelf->SingleCycleCPU__DOT__ALUOut),32);
    ...
    bufp->fullIData(oldp+96,(vlSelf->SingleCycleCPU__DOT__memData),32);
    bufp->fullIData(oldp+97,(vlSelf->SingleCycleCPU__DOT__writeBackData),32);
